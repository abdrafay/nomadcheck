    ...
    <section id="Home">
          ...
          <div className="col-12" id="bear-pic">
            ...
            <div className="alignSelf withFull">
              <InputGroup id="inputss">
                ...
                <Form.Control
                  type="text"
                  placeholder="Search by city, neighborhood or unversity"
                  aria-label="Search"
                />
                <InputGroup.Text
        ...
        <div className="container">
          <div className="row">
            <div className="col-12">
              <h2 className="bigfont fontWeight white-color">
                Best co-living experience for your <br></br> exchange semester
                in south America
              </h2>
            </div>
            <div className="row" id="next-row">
              <div className="row">
                <div className="col-md-6">
                  ...
                  <p>
                    Live,travel and make <br></br> friends with roornmates{" "}
                    <br></br> frorn all over the world{" "}
                  </p>
                </div>
                <div className="col-md-6">
                  ...
                  <p>
                    Be part of the Social <br></br> activities within our
                    Nomadroof <br></br> Community
                  </p>
                </div>
              </div>
              <div className="row">
                <div className="col-md-6">
                  ...
                  <p>
                    Enjoy the fully furnished <br></br> and confortable private
                    rooms <br></br> plus the social areas
                  </p>
                </div>
                <div className="col-md-6">
                  <img src={Image} className="" alt="" />
                  ...
                  <p>
                    Live close to your Unic or by the <br></br> pacific Ocean;
                    all of our properties <br></br> are at the safest and best
                    areas
                  </p>
                </div>
              </div>
      ...
      <section id="how-works">
        <div className="container newColor">
          <div className="row">
            <div className="col-12">
              <h1 className="bigfont fontWeight textAlign newcolr">
                HOW DOES NOMADROOF WORKS?
              </h1>
              <p className="newcolr textAlign textJustify">
                Nomadroof is the perfect platform for exchange students,
                professionals <br></br> and expats looking for mid to long-term
                accommodation.
              </p>
            </div>
          </div>
          <div className="row textAlign ">
            <div className="col-md-4 px-4">
              <div>
                <div className="rowz new-bgcolor borderRaduis boxshaodow">
                  ...
                  <h3 className="color-black fontfamily01 fontWeight marginTOp25 ">
                    Search For A Verified Roof
                  </h3>
                  <p className="marginBottom30 white-color   textAlign textJustify fontfamily01">
                    Search Through multiple flats, <br></br>rooms, appartments
                    all verified<br></br> by our Nomadroof Team.
                  </p>
                </div>
              </div>
            </div>
            <div className="col-md-4 px-4">
              ...
              >
                ...
                <p className="marginBottom30 white-color  textAlign textJustify fontfamily01">
                  When you find a match, send a <br></br>booking request and
                  Host will <br></br> give you a respond within 48 <br></br>
                  hour. We have also a Live Chat <br></br>Center to guide you.
                </p>
              </div>
            </div>
            <div className="col-md-4 px-4">
              <div className="rowz width50z height125z new-bgcolor borderRaduis boxshaodow">
                ...
                <p className="marginBottom30 white-color textAlign textJustify fontfamily01">
                  Search Through multiple flats, <br></br>rooms, appartments all
                  verified<br></br> by our Nomadroof Team.
                </p>
              </div>
            </div>
          </div>
      ...
      <div className="rowz" id="SIMPLE-ROW">
        <div className="container">
          <div className="row">
            <h2 className="bigfont fontWeight textAlign marginTop-65">
              OTHER LISTINGS
            </h2>
          </div>
          <div className="row" id="second-row">
            ...
            >
              Check the listings from independent verified host, there are
              awesome as well and <br></br> you still will get the same benefits
              like 24 hours tenant'sprotection that let you <br></br> confirm
              within this time period of your check in date that everything is
              ok with your <br></br> new home
            </p>
          </div>
          <div
            className="row"
      ...
      <div className="rowz" id="secondLast-image">
        <div className="col-12">
          ...
          >
            A WHOLE NETWORK DEDICATED <br></br> TO STUDENTS AND YOUNG
            PROFESSSIONALS
          </h2>
        </div>
          ...
          <div className="container">
            ...
            <div className="row" id="blur-row">
              <div className="col-sm-4" style={{ textAlign: "center" }}>
                ...
                >
                  More Than Students <br></br> and young Professionals
                </p>
              </div>
              <div className="col-sm-4" style={{ textAlign: "center" }}>
                ...
                >
                  More verified Flats, <br></br>Rooms, and Apartments
                </p>
              </div>
              <div className="col-sm-4" style={{ textAlign: "center" }}>
                ...
                >
                  More Than Booking<br></br> Transactions Through <br></br> Our
                  Platform
                </p>
              </div>
            </div>
          ...
          <div className="container" id="next-bordr">
            <div className="row">
              ...
              <div className="copyright">
                Copyright 2020|Nomadroof. All Rights Reserved
              </div>
            </div>
          </div>
        </div>
